...
import math
R = 1 - 4.381940022266103 /math.log(33,2)
R1 = 1 - 4.462591812647137/math.log(33,2)
R2 = 1 - 3.986465327574795 /math.log(33,2)
R3 = 1 - 4.15285963421183/math.log(33,2)
R4 = 1 - 3.9857154869183216 /math.log(33,2)
R5 = 1 - 4.1526199227621365/math.log(33,2)
...
def calculate_entropy(text):
    ...
    # Iterate through the text, counting the frequency of each bigram
    ...
    # Calculate the entropy of the text based on the bigram frequencies
    entropy = 0
    for bigram in bigram_freq:
        probability = bigram_freq[bigram] / len(text)
        entropy += probability * math.log2(probability)
...
entropy = calculate_entropy(withoutspace)
print(entropy)
